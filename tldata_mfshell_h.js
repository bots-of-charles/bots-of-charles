const tldata={
	...
	"cmd_mv":"Uso 1<br>Mover uno o más recursos (archivos o directorios) presentes en el CWD a un subdirectorio o pariente del CWD<br>A = (Obligatorio) Selección simple, rango o libre de elementos del CWD<br>B = (Obligatorio) Selección simple de un subdirectorio o un pariente del CWD<br><br>Uso 2<br>Cambiar el nombre de un recurso del CWD<br>C = (Obligatorio) Selección simple de un recurso del CWD<br>D = (Obligatorio) Nuevo nombre para el recurso. En el caso de ser un archivo, debe incluirse el sufijo (extensión)",
